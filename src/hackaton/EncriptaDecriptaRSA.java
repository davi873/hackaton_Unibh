...
public class EncriptaDecriptaRSA {
    ...
    public static void main(String[] args) {
      ...
      try {
        ...
        int count = 0;
        while(count < 3){
            String msgOriginal = JOptionPane.showInputDialog(null, "Mensagem a ser cifrada");
            final byte[] textoCriptografado = criptografa(msgOriginal, chavePublica);
            
            System.out.println("M. Original: "+msgOriginal+" M. Criptografada: " +textoCriptografado.toString());
            listaMensagem.add(textoCriptografado);
            count++;
        }
        ...
        while(count < 3){
            ...
            final String textoPuro = decriptografa((byte[]) listaMensagem.get(count), chavePrivada);
             System.out.println("M. Criptografada: "+ listaMensagem.get(count) +" M. Decriptografada: " + textoPuro);
             count++;
        }
